    ...
    <div>
      ...
      <section id='ingredients'>
       ...
       <p><input type="checkbox" name="1" id="1" /> 
        <label htmlFor="1">1 and 1/2 cups (150g) <strong>graham cracker crumbs</strong> (about 10 full sheet graham crackers)</label></p>

        <p>
          <input type="checkbox" name="2" id="2" />
          <label htmlFor="2">5 Tablespoons (70g) <strong>unsalted butter</strong>, melted</label>
        </p>

        <p>
          <input type="checkbox" name="3" id="3" />
          <label htmlFor="3">1/4 cup (50g) <strong>granulated sugar</strong></label>
        </p>
        ...
        <p>
          ...
          <label htmlFor="4">four 8-ounce blocks (904g) full-fat <strong>cream cheese</strong>, softened to room temperature</label>
        </p>
        ...
        <p>
          ...
          <label htmlFor="6">1 cup (240g) full-fat <strong>sour cream</strong>, at room temperature</label>
        </p>

        <p>
          <input type="checkbox" name="7" id="7" />
          <label htmlFor="7">1 teaspoon <strong>pure vanilla extract</strong></label>
        </p>

        <p>
          <input type="checkbox" name="8" id="8" />
          <label htmlFor="8">2 teaspoons <strong>fresh lemon juice</strong> (optional, but recommended)</label>
        </p>

        <p>
          <input type="checkbox" name="9" id="9" />
          <label htmlFor="9">3 large <strong>eggs</strong>, at room temperature</label>
        </p>
